    ...
    if action == "login":
        ...
        if provider in ("codex_cli", "claude_cli"):
            ...
            try:
                ...
                console.print(
                    Panel(str(e), title=f"{provider} login error", border_style="red")
                )
                raise SystemExit(2)
            return
        ...
        if provider == "google" and method in ("device", None):
            ...
            console.print(
                "2. [yellow]Use Gemini API Key[/yellow] (for IT professionals)"
            )
            ...
            if choice == "1":
                ...
                console.print(
                    "See: https://cloud.google.com/vertex-ai/docs/generative-ai/start/quickstarts"
                )
                return
            else:
